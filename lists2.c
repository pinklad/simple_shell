#include "shell.h"
/**
 * list_length_linked - function that checks length of list
 * @t: pointer to node
...
/**
 * list_strings -function that lists strings
...
/**
 * print_list_all - a function that prints a list
 * @t: pointer
 * Return: list
 */
...
/**
 * node_poi : function that starts the node
